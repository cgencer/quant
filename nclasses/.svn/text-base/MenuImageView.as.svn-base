package classes
{
	...
	public class MenuImageView extends ICompositeView
	{
		...
		public function MenuImageView(aModel:IWebModel, aController:MenuBrowseController, target:Sprite, type:String ) {
