package classes
{
	...
	public class MenuCompositeGallery extends ICompositeView
	{
		...
		public function MenuCompositeGallery (aModel:IWebModel, aController:MenuBrowseController, target:Sprite, type:String ) {
		...
		public function makeMenu(event:Event=null):void {
			...
			{
				var me:IComponentView = new MenuElementImage( i, (model as WebModel) );

				(me as MenuElementView0).setConstants( type, mArray[i].getName(), mArray[i].getColor(), mArray[i].getTemplate() );
